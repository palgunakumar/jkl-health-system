...
const CaregiverDetailsPageProfile = ({ caregiver }) => {
...
const mapStateToProps = state => ({
    caregiver: state.auth.user,
});

const mapDispatchToProps = (dispatch) => ({
});

export default connect(mapStateToProps, mapDispatchToProps)(CaregiverDetailsPageProfile);
