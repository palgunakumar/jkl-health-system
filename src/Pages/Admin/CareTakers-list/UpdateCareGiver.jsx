...
import { updateCaregiver } from '../../../redux/caregiver'; // Update the import path to match your project structure
...
const UpdateCaregiverDrawer = ({ open, onClose, caregiver, updateCaregiver }) => {
    ...
    const handleSubmit = () => {
        ...
        updateCaregiver(formValue); // Dispatch addCaregiver action
    ...
    return (
        <Drawer open={open} onClose={onClose} closeButton>
            <Drawer.Header>
                <Drawer.Title>Update Caregiver</Drawer.Title>
            </Drawer.Header>
            <Drawer.Body>
            <Form
                    checkTrigger="change"
                ...
                >
                    ...
                    <Stack justifyContent="flex-end" spacing={5} style={{ marginTop: 20 }}>
                        ...
                        <Button onClick={handleSubmit} appearance="primary">Update Caregiver</Button>
                    </Stack>
                </Form>
            </Drawer.Body>
        </Drawer>
...
// Mapping the updateCaregiver action to props
const mapDispatchToProps = {
    updateCaregiver, // Uncomment to map the dispatch action
};

export default connect(null, mapDispatchToProps)(UpdateCaregiverDrawer);
