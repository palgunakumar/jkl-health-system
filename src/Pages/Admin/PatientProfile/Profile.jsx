...
const PatientDetailsComponent = ({ patient, loading, fetchPatientDetails, user, userLoading }) => {
    const { uid } = user;
    useEffect(() => {
        fetchPatientDetails(uid);
    }, [uid, fetchPatientDetails]);
...
export default connect(mapStateToProps, mapDispatchToProps)(PatientDetailsComponent);
