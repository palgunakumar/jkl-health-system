...
import { addPatient, removePatientFiles, uploadPatientFiles } from '../../../redux/patientActions';
...
const AddPatientDrawer = ({ open, onClose, addPatient }) => {
    ...
    const handleSubmit = () => {
        ...
        addPatient(formValue);  // Uncomment to dispatch the action
        onClose();
    };
    useEffect(() => {
    ...
    return (
        <Drawer open={open} onClose={onClose} closeButton>
            <Drawer.Header>
                <Drawer.Title>Add Patient Details</Drawer.Title>
            </Drawer.Header>
            <Drawer.Body>
                <Form
                    checkTrigger="change"
                ...
                >
                    ...
                    <Stack alignItems="center" justifyContent="flex-start" wrap spacing={20} style={{ marginTop: "20px" }}>
                        ...
                        <Stack.Item grow={1}>
                            <TextField disabled={disabled} value={formValue.imageUrl} name="imageUrl" checkAsync type="text" label="Patient Image URL" />
                        </Stack.Item>
                    </Stack>
                    ...
                    <Stack justifyContent="flex-end" spacing={5} style={{ marginTop: 20 }}>
                        ...
                        <Button onClick={handleSubmit} appearance="primary">Add</Button>
                    </Stack>
                </Form>
            </Drawer.Body>
        </Drawer>
...
const mapDispatchToProps = {
    addPatient, // Uncomment this line to map the dispatch action
};

export default connect(null, mapDispatchToProps)(AddPatientDrawer);
